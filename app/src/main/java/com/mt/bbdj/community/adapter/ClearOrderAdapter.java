 ...
 * Description :
 */
public class ClearOrderAdapter extends RecyclerView.Adapter<ClearOrderAdapter.WaterViewHolder> {

    private List<ProductModel> mList;
    private ClearOrderClickListener clearOrderClickListener;

    public void setClearOrderClickListener(ClearOrderClickListener waterOrderClickListener) {
        this.clearOrderClickListener = waterOrderClickListener;
    }

    public ClearOrderAdapter(List<ProductModel> mList) {
        this.mList = mList;
    }
    ...
    public void onBindViewHolder(WaterViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (clearOrderClickListener != null) {
                    clearOrderClickListener.OnItemClick(position);
                }
            }
        });
    }
    ...
    public interface ClearOrderClickListener{
