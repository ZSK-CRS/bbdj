...
public class ClearOrderActivity extends BaseActivity implements XRecyclerView.LoadingListener {
    ...
    private ClearOrderAdapter adapter;
    ...
    private void initListener() {
        adapter.setClearOrderClickListener(new ClearOrderAdapter.ClearOrderClickListener() {
            @Override
            public void OnItemClick(int position) {
                ProductModel productModel = mList.get(position);
                Intent intent = new Intent(ClearOrderActivity.this,ClearServiceDetailActivity.class);
    ...
    private void requestData() {
        ...
        //传入请求参数
        Call<ResponseBody> call = retrofitApi.getServiceOrder(requestMap, "3", mPage + "");
    ...
    private void initView() {
        ...
        adapter = new ClearOrderAdapter(mList);
