...
public class HomeServiceDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_water_service_detail);
    ...
    private void initProduct() {
        ...
        mAdapter = new ProductListAdapter(productModel.getWaterMessageList());
    ...
    private void initParams() {
        ...
        tvRepairPerson.setText(productModel.getRepairPerson());
        tvRepairPhone.setText(productModel.getRepairPhone());
    }
