...
public class HomemarkActivity extends BaseActivity implements XRecyclerView.LoadingListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homemark);
        initParams();
        initView();
        initListener();
    }
    ...
    private void initListener() {
        adapter.setWaterOrderClickListener(new WaterOrderAdapter.WaterOrderClickListener() {
            ...
            public void OnItemClick(int position) {
                ...
                Intent intent = new Intent(HomemarkActivity.this,HomeServiceDetailActivity.class);
    ...
    private void requestData() {
        ...
        //传入请求参数
        Call<ResponseBody> call = retrofitApi.getServiceOrder(requestMap, "2", mPage + "");
    ...
    private void setData(JSONArray data) throws JSONException {
        for (int i = 0; i < data.length(); i++) {
            ...
            productModel.setRepairPerson(dataObj.getString("repair_name"));
            productModel.setRepairPhone(dataObj.getString("repair_mobile"));
